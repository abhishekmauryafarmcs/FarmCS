...
// Get all users
$recentUsersQuery = "SELECT user_id, email, first_name, last_name, state, district, farm_type, farm_size, created_at FROM users ORDER BY created_at DESC";
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr data-user-id="<?php echo $userId; ?>">
                                ...
                                <td>
                                    <?php if ($userId !== 'No ID'): ?>
                                        <button class="delete-btn" onclick="confirmDelete(<?php echo $userId; ?>)">
                                            Delete
                                        </button>
                                    <?php else: ?>
